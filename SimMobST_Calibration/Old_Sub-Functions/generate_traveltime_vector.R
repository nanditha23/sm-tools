...
## Data import
  # Simulation data
    SimTT <- read.csv('../../SimMobility/od_travel_time.csv', header=FALSE, sep=',')
...
## Generate vector
  ...
  ## Save vector
  write.table(trueTravelTime_RM, file='trueTravelTime_RM.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(simTravelTime_RM, file='simTravelTime_RM.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
