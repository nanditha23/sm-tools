...
sim_vehicle_counts = list(csv.reader(open("SimMobility_Plus/avgVehicleCounts.csv", "rb"), delimiter=","))
...
with open('data/truecount_Plus.csv', 'w') as fp:
		writer = csv.writer(fp, delimiter=',')
		writer.writerows(real_count)

with open('data/simcount_Plus.csv', 'w') as fp:
		writer = csv.writer(fp, delimiter=',')
		writer.writerows(sim_count)

with open('data/trueCountsRM_Plus.csv', 'w') as fp:
		writer = csv.writer(fp, delimiter=',')
		writer.writerows(real_count_rm)

with open('data/simCountsRM_Plus.csv', 'w') as fp:
		writer = csv.writer(fp, delimiter=',')
		writer.writerows(sim_count_rm)

with open('data/compare_counts_Plus.csv', 'w') as fp:
		writer = csv.writer(fp, delimiter=",")
