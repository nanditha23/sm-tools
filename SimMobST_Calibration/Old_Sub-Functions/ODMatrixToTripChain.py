...
cur.execute("truncate table demand.temp_trips_activities_shortterm_calibration_plus")
cur.execute("truncate table demand.temp_subtrips_shortterm_calibration_plus")
...
if len(OD_counts) == len(OD_intervals):
    ...
    query = "select * from demand.trips_activities_plus"
    ...
    query = "select * from demand.subtrips_plus"
    ...
    tripsFile = open('copy_trips_plus.csv', 'w+')
    subTripsFile = open('copy_subtrips_plus.csv', 'w+')
