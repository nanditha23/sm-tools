...
## Data import
  # Simulation data
    SimTT <- read.csv('../../SimMobility_Minus/od_travel_time.csv', header=FALSE, sep=',')
...
## Generate vector
  ...
  ## Save vector
  write.table(trueTravelTime, file='trueTravelTime_Minus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(simTravelTime, file='simTravelTime_Minus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(trueTravelTime_RM, file='trueTravelTime_RM_Minus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(simTravelTime_RM, file='simTravelTime_RM_Minus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(trueTravelTime_Var, file='trueTravelTime_Var_Minus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(trueTravelTime_Obs, file='trueTravelTime_Obs_Minus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
