...
## Generate vector
  ...
  ## Save vector
  write.table(trueTravelTime, file='trueTravelTime_Plus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(simTravelTime, file='simTravelTime_Plus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  ...
  write.table(trueTravelTime_Var, file='trueTravelTime_Var_Plus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
  write.table(trueTravelTime_Obs, file='trueTravelTime_Obs_Plus.csv', sep = ',', row.names = FALSE, col.names = FALSE) 
