...
theta_OD_dash <- read.table('theta_OD_dash_SPSA.csv', header=FALSE); colnames(theta_OD_dash) <- c('Trips')
...
# ODdata
  ...
  write.table(Truncated_theta_od, file='Truncated_theta_od_SPSA.csv', row.names=FALSE, col.names=FALSE)
