...
sim_vehicle_counts <- read.table('SimMobility_SPSA/avgVehicleCounts.csv', sep = ',')
...
# File export
  # data/truecount_SPSA.csv
  write.table(Data_Seg$Count_Real, file='data/truecount_SPSA.csv', row.names = F, col.names=F)
  # data/simcount_SPSA.csv
  write.table(Data_Seg$Count_Sim, file='data/simcount_SPSA.csv', row.names = F, col.names=F)
  # data/trueCountsRM_SPSA.csv
  write.table(Data_Seg$Count_Real, file='data/trueCountsRM_SPSA.csv', row.names = F, col.names=F)
  # data/simCountsRM_SPSA.csv
  write.table(Data_Seg$Count_Sim, file='data/simCountsRM_SPSA.csv', row.names = F, col.names=F)
  # data/compare_counts_SPSA.csv
  write.table(Data_Seg, file='data/compare_counts_SPSA.csv', row.names = F, col.names=F)
  # data/trueCountsVar_SPSA.csv
  write.table(Data_Seg$Var_Real, file='data/trueCountsVar_SPSA.csv', row.names = F, col.names=F)
  # data/trueCountsObs_SPSA.csv
  write.table(Data_Seg$Obs_Real, file='data/trueCountsObs_SPSA.csv', row.names = F, col.names=F)
