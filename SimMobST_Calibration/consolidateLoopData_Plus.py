...
for i in range(1, n_iter+1):
	all_loop_data[i] = list(csv.reader(open("SimMobility_Plus/VehicleCounts_" + str(i) +".csv", "rb"), delimiter=","))
...
writer = csv.writer(open('SimMobility_Plus/avgVehicleCounts.csv', 'wb'))
