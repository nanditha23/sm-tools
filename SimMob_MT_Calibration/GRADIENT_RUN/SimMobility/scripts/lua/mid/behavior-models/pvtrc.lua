...
local beta_bTTVOT = -0.0010320396
local beta_bCommonFactor = 0.9323559604
local beta_bLength = -1.42871373948999e-06
local beta_bHighway = 7.77874468981924e-05
local beta_bCost = 0.0
local beta_bSigInter = -0.0010589895
local beta_bLeftTurns = 0.0
local beta_bWork = 0.0
local beta_bLeisure = 0.0
local beta_highwayBias = 0.1554330033
local beta_minTravelTimeParam = 0.6156696826
local beta_minDistanceParam = 0.0306092084
local beta_minSignalParam = 0.0229331808
local beta_maxHighwayParam = 0.2858049192
