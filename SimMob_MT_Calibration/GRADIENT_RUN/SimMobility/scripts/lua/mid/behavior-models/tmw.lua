...
local beta_cons_bus = -1.838
local beta_cons_mrt = -2.061
local beta_cons_privatebus = -3.591
local beta_cons_drive1 = -0.579
local beta_cons_share2 = -4.098
local beta_cons_share3 = -7.526
local beta_cons_motor = 16.822
local beta_cons_walk = 2.877
local beta_cons_taxi = -2.564
