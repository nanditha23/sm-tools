...
local beta_cons_bus = 4.192
local beta_cons_mrt = 4.519
local beta_cons_private_bus = 2.659
local beta_cons_drive1 = -2.279
local beta_cons_share2 = 2.152
local beta_cons_share3 = 1.224
local beta_cons_motor = 15.322
local beta_cons_walk = -99.031
local beta_cons_taxi = -1.474
