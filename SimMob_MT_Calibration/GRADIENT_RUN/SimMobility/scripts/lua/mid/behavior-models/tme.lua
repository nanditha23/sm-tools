...
local beta_cons_bus = -2.408
local beta_cons_mrt = -3.531
local beta_cons_privatebus = -2.691
local beta_cons_drive1 = -4.279
local beta_cons_share2 = -7.598
local beta_cons_share3 = -7.226
local beta_cons_motor = 13.472
local beta_cons_walk = 3.245
local beta_cons_taxi = -2.574
