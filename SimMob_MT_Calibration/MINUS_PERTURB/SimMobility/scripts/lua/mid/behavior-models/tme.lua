...
local beta_cons_bus = -1.5255373966044878
local beta_cons_mrt = -2.6662650234436871
local beta_cons_privatebus = -1.8155351440410126
local beta_cons_drive1 = -4.8827656488234679
local beta_cons_share2 = -6.8905743858167909
local beta_cons_share3 = -6.5136293109616474
local beta_cons_motor = 11.002075064803766
local beta_cons_walk = 4.2397997755765431
local beta_cons_taxi = -1.4272091501021098

local beta1_1_tt = -0.67097515837035537
...
local beta_twoplus_share2 = 2.8346125346639242
local beta_threeplus_share2 = 0.140

local beta_zero_share3 = 0
local beta_oneplus_share3 = 2.8550790511596924
...
local beta_age_over_15_bus = 1.9045146416625807
local beta_age_over_15_mrt = 2.5173815289795138
