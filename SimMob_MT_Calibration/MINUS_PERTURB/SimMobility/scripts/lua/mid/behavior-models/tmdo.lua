...
local beta_log = 0.23945824300049035
local beta_area = 0
local beta_population = -6.6218509079345109

local beta_central_bus_mrt = 0.78284425596314144
...
local beta_central_taxi = 1.4428894129516725
...
local beta_cons_bus = 0.074967008463191931
local beta_cons_mrt = -0.56503299153680686
local beta_cons_private_bus = -4.4769670084631912 
local beta_cons_drive1 = 3.4369670084631929
local beta_cons_share2 = 0.10303299153680889
local beta_cons_share3 = -1.7990329915368068
local beta_cons_motor = -1.2569670084631905
local beta_cons_walk = -3.7530329915368075
local beta_cons_taxi = -1.6130329915368069

local beta_zero_bus = 0
local beta_oneplus_bus = -1.3507900887207147
local beta_twoplus_bus = -0.73577126802287407
...
local beta_oneplus_taxi = -1.5042889624389777
