...
local beta_cons_work = -4.3069670084631912
local beta_cons_edu = -2.7130329915368065
local beta_cons_shopping = -2.9369670084631903
local beta_cons_other = -2.5430329915368066
local beta_cons_Q = 0


local beta_first_stop_inbound = 0
local beta_second_stop_inbound = 5.4338601296265105
local beta_threeplus_stop_inbound = 1.73
local beta_first_stop_outbound = 0.2275650828242981
local beta_second_stop_outbound = 2.2463506029866336
...
local beta_first_tour_dummy_Q = -1.4326561547037882
...
local beta_time_window_work_second_stop_first_bound = 3.5100075790242813
...
local beta_time_window_other_second_stop_first_bound = 1.3575771035440958
