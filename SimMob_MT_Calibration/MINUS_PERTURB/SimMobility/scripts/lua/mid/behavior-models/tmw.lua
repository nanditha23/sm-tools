...
local beta_cons_bus = -2.7301661465074947
local beta_cons_mrt = -2.9398237747285183
local beta_cons_privatebus = -2.7271047531360697
local beta_cons_drive1 = 0.052756638569573688
local beta_cons_share2 = -3.345882105522179
local beta_cons_share3 = -6.8070047767217368
local beta_cons_motor = 19.315250759984657
local beta_cons_walk = 3.8825296549792192
local beta_cons_taxi = -3.7218006391980243

local beta1_1_tt = -0.717
local beta1_2_tt = -1.4019563799601358
local beta1_3_tt = -3.4476598384968766
...
local beta4_1_cost = -8.2480061477946673
...
local beta_central_mrt = 1.1563581820109148
...
local beta_oneplus_motor = 8.008728236734953
