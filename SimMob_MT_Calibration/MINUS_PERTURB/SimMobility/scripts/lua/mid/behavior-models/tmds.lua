...
local beta_tt_bus_mrt = -2.7151542070881916
local beta_tt_private_bus = 0 
local beta_tt_drive1 = -4.65
local beta_tt_share2 = -3.6737397109904282
local beta_tt_share3= -2.14
local beta_tt_motor = 0
local beta_tt_walk = -5.05
local beta_tt_taxi = -3.33

local beta_log = 1.1665914402587989
local beta_area = 3.3304589374714872
...
local beta_cons_bus = -0.27096700846319166
local beta_cons_mrt = -1.2129670084631918
local beta_cons_private_bus = -4.5820329915368063
local beta_cons_drive1 = 5.332032991536809
local beta_cons_share2 = -4.2130329915368065
local beta_cons_share3 = -3.3469670084631904
local beta_cons_motor = -1.6049670084631913
local beta_cons_walk = -5.8369670084631906
local beta_cons_taxi = -6.0930329915368073
...
local beta_oneplus_share2 = 3.564860739522266
