...
local beta_bTTVOT = -0.0008999999999996788
local beta_bCommonFactor = 1.0100175175755506
local beta_bLength = -1.879999995679782e-07
local beta_bHighway = 7.0529621469849298e-05
local beta_bCost = 0.0
local beta_bSigInter = -0.46747667805428428
local beta_bLeftTurns = 0.0
local beta_bWork = 0.0
local beta_bLeisure = 0.0
local beta_highwayBias = 0.15026092121011314
local beta_minTravelTimeParam = 0.67218066218394268
local beta_minDistanceParam = 0.30958607286950551
local beta_minSignalParam = 0.01
local beta_maxHighwayParam = 0.26007141031582565
