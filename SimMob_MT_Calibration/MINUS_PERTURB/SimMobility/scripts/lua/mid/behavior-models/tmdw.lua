...
local beta_log = 0.81149737905721731
...
local beta_cons_bus = 0.33696700846319239
local beta_cons_mrt = 0.61496700846319285
local beta_cons_private_bus = 0.024967008463192997
local beta_cons_drive1 = 5.234967008463193
local beta_cons_share2 = 0.37196700846319253
local beta_cons_share3 = -3.6950329915368076
local beta_cons_motor = -0.84396700846319028
local beta_cons_walk = -182.85967008463192
local beta_cons_taxi = -3.9160329915368077
...
local beta_oneplus_privatebus = -3.6225734197510073
...
local beta_oneplus_car_motor = -3.192776573339871
...
local beta_oneplus_taxi = -2.9593227508910864
...
local beta_female_bus = 1.8947478999104648
local beta_female_mrt = 1.60
local beta_female_private_bus = 1.4428894129516725
