...
local beta_shop = 1.0018359824678633
...
local beta_cons_bus = 4.9930088232343506
local beta_cons_mrt = 3.6785238812236427
local beta_cons_private_bus = 3.5322255767792958
local beta_cons_drive1 = -1.6638513486797821
local beta_cons_share2 = 1.4184494620537622
local beta_cons_share3 = 0.49399498742160119
local beta_cons_motor = 12.840878668905322
local beta_cons_walk = -108.451740812248
local beta_cons_taxi = -0.29595254488562794

local beta_zero_drive1 = 0
local beta_oneplus_drive1 = 3.7406620910603507
local beta_twoplus_drive1 = 0.0514
local beta_threeplus_drive1 = 0

local beta_zero_share2 = 0
local beta_oneplus_share2 = 2.1193829602091281
