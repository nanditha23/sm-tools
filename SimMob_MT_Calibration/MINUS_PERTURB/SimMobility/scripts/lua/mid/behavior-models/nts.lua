...
--person type
local beta_parttime_shopping_2=0
local beta_selfemployed_shopping_2 = 0
local beta_universitystudent_shopping_2 = 0
local beta_homemaker_shopping_2 = 0
local beta_retired_shopping_2 = 0
local beta_unemployed_shopping_2 = 0
local beta_nationalservice_shopping_2 = 0
local beta_voluntary_shopping_2 = 0
local beta_domestic_shopping_2 = 0
local beta_otherworker_shopping_2 = 0
local beta_student16_shopping_2 = 0
local beta_student515_shopping_2 = 0
local beta_child4_shopping_2 = 0

--Adult age group

local beta_age2025_shopping_2 = 0
local beta_age2635_shopping_2 = 0
local beta_age5165_shopping_2 = 0

--Adult gender/children

local beta_maleage4_shopping_2 = 0
local beta_maleage515_shopping_2 = 0
local beta_femalenone_shopping_2 = 0
local beta_femaleage4_shopping_2 = 0
local beta_femaleage515_shopping_2 = 0

--Household composition
local beta_onlyadults_shopping_2 = 0
local beta_onlyworkers_shopping_2 = 0

--Personal income
local beta_income_shopping_2 = 0

--Others
local beta_workathome_shopping_2 = 0
local beta_caravail_shopping_2 = 1.3507900887207147
local beta_motoravail_shopping_2 = -0.35257937725138028
local beta_logsum_shopping_2 = 0.13814898634643674
local beta_cons_shopping_2 = -6.7830329915368068
