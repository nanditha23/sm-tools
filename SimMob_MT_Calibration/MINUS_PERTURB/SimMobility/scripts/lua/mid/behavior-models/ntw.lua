...
local beta_femalenone_work_2 = -0.86675697359579185
local beta_femalenone_work_3 = 0

local beta_femaleage4_work_2 = -1.4735891876953251
local beta_femaleage4_work_3 = 0

local beta_femaleage515_work_2 = -0.62627540477051313
...
local beta_motoravail_work_2 = 0.6815349993090879
local beta_motoravail_work_3 = 0

local beta_logsum_work_2 = 0.35714071285115861
local beta_logsum_work_3= 0

local beta_cons_work_2 = -10.853032991536807
