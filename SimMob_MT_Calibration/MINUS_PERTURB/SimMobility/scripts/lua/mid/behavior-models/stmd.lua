...
local beta_cost_bus_mrt_1 = -0.18556809329020016
local beta_cost_private_bus_1 = -0.67976522594725952
...
local beta_tt_drive1 = -4.7482318270182695
local beta_tt_share2 = -5.45
local beta_tt_share3 = -3.4476598384968766
local beta_tt_motor = 0
local beta_tt_walk = -0.675
local beta_tt_taxi = 0

local beta_log = 0.79307751421102568
local beta_area = 0
...
local beta_cons_bus = 3.7330329915368088
local beta_cons_mrt = 1.2769670084631928
local beta_cons_private_bus = 1.1609670084631931
local beta_cons_drive1 = -0.53303299153680683
local beta_cons_share2 = 0.91696700846319246
local beta_cons_share3 = 1.8030329915368082
local beta_cons_motor = -4.3669670084631917
local beta_cons_walk = -0.78696700846319168
local beta_cons_taxi = -4.523032991536807
...
local beta_mode_work_drive1 = 5.8022574265503426
