...
--travel constants
local cons_travel = 4.263643785912671

--Person type
local beta_homemaker = 0.442
local beta_retired = -0.419
local beta_fulltime = 4.1956358816325228
...
local beta_age2635_travel = -2.8030548828572339
local beta_age3650_travel = -2.617486789567034
local beta_age5165_travel = -2.9369451171427663
local beta_age65_travel = -3.0802107326131445
