...
local beta_shop = 0.95616401753213665
...
local beta_cons_bus = 3.3909911767656515
local beta_cons_mrt = 5.3594761187763558
local beta_cons_private_bus = 1.7857744232207002
local beta_cons_drive1 = -2.8941486513202177
local beta_cons_share2 = 2.8855505379462381
local beta_cons_share3 = 1.9540050125783992
local beta_cons_motor = 17.803121331094676
local beta_cons_walk = -89.610259187752007
local beta_cons_taxi = -2.6520474551143725

local beta_zero_drive1 = 0
local beta_oneplus_drive1 = 3.9193379089396494
local beta_twoplus_drive1 = 0.0514
local beta_threeplus_drive1 = 0

local beta_zero_share2 = 0
local beta_oneplus_share2 = 2.2206170397908718
