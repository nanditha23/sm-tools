...
local beta_femalenone_work_2 = -0.8272430264042081
local beta_femalenone_work_3 = 0

local beta_femaleage4_work_2 = -1.4064108123046748
local beta_femaleage4_work_3 = 0

local beta_femaleage515_work_2 = -0.59772459522948684
...
local beta_motoravail_work_2 = 0.65046500069091218
local beta_motoravail_work_3 = 0

local beta_logsum_work_2 = 0.34085928714884134
local beta_logsum_work_3= 0

local beta_cons_work_2 = -8.986967008463191
