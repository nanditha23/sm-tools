...
local beta_cost_bus_mrt_1 = -0.19443190670979985
local beta_cost_private_bus_1 = -0.71223477405274038
...
local beta_tt_drive1 = -4.5317681729817298
local beta_tt_share2 = -5.45
local beta_tt_share3 = -3.612340161503123
local beta_tt_motor = 0
local beta_tt_walk = -0.675
local beta_tt_taxi = 0

local beta_log = 0.75692248578897436
local beta_area = 0
...
local beta_cons_bus = 1.8669670084631926
local beta_cons_mrt = 3.1430329915368089
local beta_cons_private_bus = 3.0270329915368093
local beta_cons_drive1 = 1.3330329915368093
local beta_cons_share2 = 2.7830329915368086
local beta_cons_share3 = -0.06303299153680797
local beta_cons_motor = -6.2330329915368079
local beta_cons_walk = -2.6530329915368078
local beta_cons_taxi = -2.6569670084631909
...
local beta_mode_work_drive1 = 5.5377425734496573
