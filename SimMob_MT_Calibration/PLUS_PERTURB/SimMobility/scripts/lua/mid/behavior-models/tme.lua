...
local beta_cons_bus = -3.2904626033955129
local beta_cons_mrt = -4.3957349765563141
local beta_cons_privatebus = -3.5664648559589871
local beta_cons_drive1 = -3.675234351176532
local beta_cons_share2 = -8.305425614183207
local beta_cons_share3 = -7.9383706890383525
local beta_cons_motor = 14.0
local beta_cons_walk = 2.2502002244234554
local beta_cons_taxi = -3.7207908498978899

local beta1_1_tt = -0.70302484162964474
...
local beta_twoplus_share2 = 2.7053874653360763
local beta_threeplus_share2 = 0.140

local beta_zero_share3 = 0
local beta_oneplus_share3 = 2.7249209488403077
...
local beta_age_over_15_bus = 1.9954853583374192
local beta_age_over_15_mrt = 2.4026184710204861
