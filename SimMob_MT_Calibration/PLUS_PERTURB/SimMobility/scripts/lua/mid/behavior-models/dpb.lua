...
--travel constants
local cons_travel = 2.4303562140873298

--Person type
local beta_homemaker = 0.442
local beta_retired = -0.419
local beta_fulltime = 4.0043641183674765
...
local beta_age2635_travel = -2.9369451171427663
local beta_age3650_travel = -2.7425132104329664
local beta_age5165_travel = -2.8030548828572339
local beta_age65_travel = -2.9397892673868551
