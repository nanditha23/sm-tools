...
local beta_log = 0.77450262094278277
...
local beta_cons_bus = 2.2030329915368085
local beta_cons_mrt = 2.481032991536809
local beta_cons_private_bus = 1.8910329915368091
local beta_cons_drive1 = 7.1010329915368091
local beta_cons_share2 = 2.2380329915368087
local beta_cons_share3 = -1.8289670084631915
local beta_cons_motor = -2.7100329915368064
local beta_cons_walk = -201.52032991536805
local beta_cons_taxi = -2.0499670084631916
...
local beta_oneplus_privatebus = -3.4574265802489923
...
local beta_oneplus_car_motor = -3.0472234266601292
...
local beta_oneplus_taxi = -3.1006772491089132
...
local beta_female_bus = 1.9852521000895351
local beta_female_mrt = 1.60
local beta_female_private_bus = 1.3771105870483273
