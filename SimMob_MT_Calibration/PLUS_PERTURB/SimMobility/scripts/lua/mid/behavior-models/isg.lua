...
local beta_cons_work = -6.1730329915368074
local beta_cons_edu = -0.8469670084631904
local beta_cons_shopping = -4.8030329915368064
local beta_cons_other = -0.67696700846319047
local beta_cons_Q = 0


local beta_first_stop_inbound = 0
local beta_second_stop_inbound = 5.1861398703734887
local beta_threeplus_stop_inbound = 1.73
local beta_first_stop_outbound = 0.23843491717570192
local beta_second_stop_outbound = 2.3536493970133661
...
local beta_first_tour_dummy_Q = -1.3673438452962117
...
local beta_time_window_work_second_stop_first_bound = 3.3499924209757186
...
local beta_time_window_other_second_stop_first_bound = 1.422422896455904
