...
local beta_cons_bus = -0.94583385349250371
local beta_cons_mrt = -1.1821762252714798
local beta_cons_privatebus = -4.4548952468639289
local beta_cons_drive1 = -1.2107566385695723
local beta_cons_share2 = -4.8501178944778207
local beta_cons_share3 = -8.2449952232782628
local beta_cons_motor = 14.328749240015343
local beta_cons_walk = 1.8714703450207821
local beta_cons_taxi = -1.4061993608019741

local beta1_1_tt = -0.717
local beta1_2_tt = -1.3380436200398644
local beta1_3_tt = -3.612340161503123
...
local beta4_1_cost = -7.8719938522053337
...
local beta_central_mrt = 1.103641817989085
...
local beta_oneplus_motor = 8.3912717632650455
