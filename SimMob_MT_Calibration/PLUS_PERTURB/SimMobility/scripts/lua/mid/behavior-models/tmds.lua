...
local beta_tt_bus_mrt = -2.8448457929118081
local beta_tt_private_bus = 0 
local beta_tt_drive1 = -4.65
local beta_tt_share2 = -3.5062602890095711
local beta_tt_share3= -2.14
local beta_tt_motor = 0
local beta_tt_walk = -5.05
local beta_tt_taxi = -3.33

local beta_log = 1.1134085597412009
local beta_area = 3.489541062528513
...
local beta_cons_bus = -2.1370329915368078
local beta_cons_mrt = -3.079032991536808
local beta_cons_private_bus = -2.7159670084631902
local beta_cons_drive1 = 3.4659670084631928
local beta_cons_share2 = -2.3469670084631904
local beta_cons_share3 = -5.2130329915368065
local beta_cons_motor = -3.4710329915368074
local beta_cons_walk = -7.7030329915368068
local beta_cons_taxi = -4.2269670084631912
...
local beta_oneplus_share2 = 3.7351392604777338
