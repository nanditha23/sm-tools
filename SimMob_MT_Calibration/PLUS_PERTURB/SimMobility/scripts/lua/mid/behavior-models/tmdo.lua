...
local beta_log = 0.22854175699950968
local beta_area = 0
local beta_population = -6.9381490920654887

local beta_central_bus_mrt = 0.74715574403685858
...
local beta_central_taxi = 1.3771105870483273
...
local beta_cons_bus = 1.9410329915368081
local beta_cons_mrt = 1.3010329915368093
local beta_cons_private_bus = -6.3430329915368073 
local beta_cons_drive1 = 5.3030329915368091
local beta_cons_share2 = -1.7630329915368073
local beta_cons_share3 = 0.067032991536809305
local beta_cons_motor = -3.1230329915368067
local beta_cons_walk = -1.8869670084631913
local beta_cons_taxi = 0.25303299153680925

local beta_zero_bus = 0
local beta_oneplus_bus = -1.2892099112792854
local beta_twoplus_bus = -0.70222873197712588
...
local beta_oneplus_taxi = -1.4357110375610223
